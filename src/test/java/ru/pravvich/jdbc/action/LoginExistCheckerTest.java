...
public class LoginExistCheckerTest {

    @Test
    public void whenLoginNotExistInUsersTableThenLoginIsExistReturnFalse()
            throws SQLException {

        final PropertiesLoader properties = mock(PropertiesLoader.class);
        when(properties.get("login_exist")).thenReturn("mock_script");
        ...
        final LoginExistChecker checker =
                new LoginExistChecker(connection, properties);

        final boolean result = checker.loginIsExist("test");

        Assert.assertFalse(result);

        verify(properties).get("login_exist");
    ...
    @Test
    public void whenLoginIsExistThenLoginIsExistReturnTrue()
            throws SQLException {
